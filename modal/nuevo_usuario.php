           ...
           <div class="modal-body">
                <form class="form-horizontal" method="post" id="guardar_usuario" name="guardar_usuario">
                    <div class="form-group">
                        <label for="NombresApellidos" class="col-control-label">Usuario</label>
        
                            <input id="Nombres"   name="Nombres_txt" class="form-control" value="<?php echo $NombresP; ?>" required/>
                            
            </div>
                    <div class="form-group">
                        <label for="Cedula" class="col-control-label">Correo</label>
