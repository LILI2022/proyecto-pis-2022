        ...
        <div class="container">
            ...
            <div class="login-form">
                ...
                <form class="form-signin">
                    <i class='bi bi-person-circle'></i> <strong> Usuario</strong>  <input class="form-control" type="text" id="UsuarioTxt" name="Usuario" placeholder="ingrese el nombre del usuario" >
